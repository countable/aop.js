...
var AOP = function(host_fn) {
    ...
    var _attrs = {
        ...
        on: function(opts) {
            ...
            this._reg = this._reg || {before:[],after:[]};
		...
		purge: function() {
			this._reg = { before:[], after:[] };
		}
    }, fnOut = function() {
        var _args = arguments, _this=this, i,
            _r = arguments.callee._reg = arguments.callee._reg || {before:[],after:[]};
    ...
    for (var k in _attrs) { fnOut[k] = _attrs[k]; }
    return fnOut;
}
